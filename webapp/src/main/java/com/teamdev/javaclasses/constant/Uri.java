package com.teamdev.javaclasses.constant;
...
public class Uri {
    ...
    public final static String JOIN_CHAT_URI = "/chat/join-chat";
    public final static String LEAVE_CHAT_URI = "/chat/leave-chat";
    public final static String POST_MESSAGE_URI = "/chat/post-message";
